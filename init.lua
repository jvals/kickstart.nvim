...
-- },
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = function(_, opts)
      opts.ensure_installed = { 'bash', 'c', 'diff', 'haskell', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'python', 'query', 'vim', 'vimdoc', 'typst' }
      ...
      opts.textobjects = {
        swap = {
          ...
          swap_previous = {
            ['<leader>A'] = '@parameter.inner', -- swap with previous arg
          },
        },
      }
    ...
    dependencies = {
      'nvim-treesitter/nvim-treesitter-textobjects', -- loads first
    },
  },
  -- { -- Extra Tree-sitter text-objects (lazy-loads after nvim-treesitter)
